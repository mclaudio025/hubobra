...
export default function EditarCategoriaPage() {
  ...
  const loadCategories = async () => {
    try {
      ...
      // Filtrar a categoria atual para não permitir que seja pai de si mesma
      const filteredCategories = (response || []).filter(cat => cat.id !== categoryId);
  ...
  return (
    <div>
      ...
      <div className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Editar Categoria</h1>
        <p className="text-gray-600">Edite as informações da categoria "{categoryName}"</p>
      </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Deixe em branco para manter como categoria principal
                  </p>
                </div>
              </div>
            </div>
